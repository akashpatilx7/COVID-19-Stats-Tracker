...
change_country_btn.addEventListener("click", function(){
    input.value="";
    // Here, the input value is set to empty after searching for one country and again coming to search for an another country in search box.
    resetCountryList(); // Generating a new function for the above specified purpose
